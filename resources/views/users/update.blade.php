...
<div class="mb-3">
    ...
    <div>
        <input type="text" class="form-control" id="name" placeholder="Masukkan Nama" value="{{ $data->name }}">
...
<div class="mb-3">
    ...
    <div class="input-group input-group-flat">
        <input type="password" id="password" class="form-control" placeholder="Masukkan password" autocomplete="off" disabled>
